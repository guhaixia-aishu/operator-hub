...
func (m *MockValidator) ValidatorURL(ctx context.Context, url string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidatorURL", ctx, url)
	ret0, _ := ret[0].(error)
	return ret0
}

// ValidatorURL indicates an expected call of ValidatorURL.
func (mr *MockValidatorMockRecorder) ValidatorURL(ctx, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidatorURL", reflect.TypeOf((*MockValidator)(nil).ValidatorURL), ctx, url)
}
